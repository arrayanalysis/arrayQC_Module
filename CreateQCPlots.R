# version 1.3.0
## CreateHeatmap / CreatePCAplot
# - Now includes compatibility with list objects generated by arrayQC
## imageplot3by2Adp
# - Improved parameter check
# - name must now be a character string! Removed deparse(substitute())
## CreatePCAplot
# - Made some changes in file name generation

## General improvements:
# - Added image.width and image.height parameters for plot customization.
...
HierarchCluster <- function(x, dist.method = "euclidean", clust.method = "ward", main, data.return=FALSE, image.width=1600, image.height=1400, pointsize=25, ...) {
...
CreateHeatMap <- function(data, main=NULL, image.width=2000, image.height=1400, pointsize=25) {
